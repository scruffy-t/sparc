...
class ModelTest(QtCore.QObject):
    ...
    def index(self):
        ...
        assert(self.model.index(0,0, QtCore.QModelIndex()).is_valid() == True)
    ...
    def data(self):
        ...
        assert(not self.model.data(QtCore.QModelIndex(), QtCore.Qt.DisplayRole).is_valid())

        if self.model.rowCount(QtCore.QModelIndex()) == 0:
            return

        # A valid index should have a valid QtCore.QVariant data
        assert(self.model.index(0,0, QtCore.QModelIndex()).is_valid())
    ...
    def checkChildren(self, parent, depth = 0):
        ...
        for r in range(0,rows):
            ...
            for c in range(0,cols):
                ...
                assert(self.model.data(index, QtCore.Qt.DisplayRole).is_valid() == True)
